...
export default function Install() {
  ...
  return (
    <Layout>
      <SEOHead
        title="Install Fent Finder | Offline Access"
        description="Install Fent Finder on your device for offline access to education content and safety checklists."
        path="/install"
      />
          ...
          <Card className="mb-6">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Install Fent Finder on your device for quick access. Education content and safety checklists are available offline.
              </p>
